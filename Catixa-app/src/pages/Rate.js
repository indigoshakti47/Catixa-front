...
const REACTIONS = [
  ...
  { label: "Bueno", src: require('./assets/ambitious.png'), bigSrc: require('./assets/ambitious_big.png') },
  { label: "Excelente", src: require('./assets/surprised.png'), bigSrc: require('./assets/surprised_big.png') },
];
const WIDTH = 320;
